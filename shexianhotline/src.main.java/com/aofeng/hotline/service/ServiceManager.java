...
public class ServiceManager {
	private static Class<? extends AbstractService> mServiceClass;
	private static Context mActivity;
    private static boolean mIsBound;
    private static Messenger mService = null;
    private static Handler mIncomingHandler = null;
    ...
    /**
     * Tie the activity and service together and establish the two-way communication channel
     * @param context  Activity the service is bound to
     * @param serviceClass  the service
     * @param incomingHandler the handler for messages from service
     */
    public ServiceManager(Context context, Class<? extends AbstractService> serviceClass, Handler incomingHandler) {
    	...
    	if (Util.isServiceRunning(mActivity, mServiceClass.getName())) {
    		doBindService();
    	}
    }
